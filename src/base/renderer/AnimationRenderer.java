...
public class AnimationRenderer extends Renderer {
    ...
    public void render(Graphics g, GameObject master) {
        int x = (int) (master.position.x - master.anchor.x*images.get(currentImageIndex).getWidth());
        int y = (int) (master.position.y - master.anchor.y*images.get(currentImageIndex).getHeight());
